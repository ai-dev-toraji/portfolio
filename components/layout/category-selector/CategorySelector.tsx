...
export default function CategorySelector({ categories }: CategorySelectorProps) {
  ...
  const baseClass = "px-4 py-2 text-sm tracking-wide text-left border-b border-(--color-primary)/30 transition-colors duration-200";
  const activeClass = "text-(--color-accent)";
  const inactiveClass = "text-(--color-primary) hover:text-(--color-accent)";
